      ...
      <div key={index} className="col-md-6 col-lg-4">
        <div className="card mb-4">
          ...
          <div className="card-body">
            ...
            <h5>Number of friends: {friend.num_friends}</h5>
      ...
      <>
        <section className="jumbotron jumbotron-fluid text-center">
          <div className="container py-5">
            <h1 className="display-4">List of avaiable friends</h1>
            <p className="lead text-muted">
              Look at these talented and charming indivisuals.
            </p>
          </div>
        </section>
        <div className="py-5">
          <main className="container">
            <div className="row">
              {friends.length > 0 ? friendItems : noFriend}
            </div>
